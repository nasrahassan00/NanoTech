...
3. Informational content about nanotechnology
4. Embedded video (currently desktop only)
...
1. Add mobile & tablet responsiveness
2. Fix the video aspect-ratio issue
3. Improve accessibility and color contrast
